"""
Django settings for capstone_hosting project.
...
SECRET_KEY = 'django-insecure-@g0u5^7pe!u##%(a)0kg-8*6s%hva&nx$fi*_o0#m6k6dggohb'
...
ROOT_URLCONF = 'capstone_hosting.urls'
...
WSGI_APPLICATION = 'capstone_hosting.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'capstone_hosting_database',
        'USER': 'root',
